...
export interface Races {
	...
	changeling_shifter: RacePayload;
	dhampir: RacePayload;
...
export async function seedRaces(params: SeedRacesParams): Promise<Races> {
	...
	return {
		...
		changeling_shifter: await db.createRace({
			id: 'race-changeling-shifter',
			name: 'Changeling Shifter',
			description:
				"A hybrid born with one parent as a changeling and the other as a shifter, these beings inherit the shapeshifting abilities of both lineages. They can alter their appearance like changelings and tap into primal, bestial traits like shifters.",
			ageAdulthood: 18,
			ageLifespan: 200,
			heightRangeLow: 5.4,
			heightRangeHigh: 7.0,
			...
			weightRangeHigh: 190,
			playstyle:
			'Adaptive melee combatants with shapeshifting and primal abilities. Ideal for players who want versatility in both social and combat situations.',
			defaultCreatureSizeId: creatureSizes.medium.id,
			languages: {
				connect: [
					{ id: languages.common.id },
			...
			additionalProperties: {
				alabastriaLore:
				"Only one of these hybrids has ever been recorded, Auren Wildfist; whose parents are very protective of allowing outsiders to know of his unique heritage. Living and training within the Huntbound Order's guild hall, Auren has been able to harness both changeling and shifter abilities.",
				abilityScoreIncreases: ['+2 Cha', '+1 Str'],
				alignment:
					"Changeling shifters have only been described as neutral, balancing the chaotic nature of the shapeshifting with the primal instincts inherited from their shifter lineage.",
				speed: '30 feet',
				traits: [
					"Shapechanger: As an action, you can change your appearance and your voice. You determine the specifics of the changes, including your coloration, hair length, and sex. You can also adjust your height and weight, but not so much that your size changes. You can make yourself appear as a member of another race, though none of your game statistics change. You can't duplicate the appearance of a creature you've never seen, and you must adopt a form that has the same basic arrangement of limbs that you have. Your clothing and equipment aren't changed by this trait. You stay in the new form until you use an action to revert to your true form or until you die.",
					'Changeling Instincts: You gain proficiency with two of the following skills of your choice: Deception, Insight, Intimidation, and Persuasion.',
