...
export async function seedDeityHistories(
	params: SeedDeityHistoriesParams
): Promise<DeityHistories> {
	...
	return {
		cyric_bringing_history: await db.createDeityHistory({
			...
			description:
				"The Bringing weakened Cyric's divine coherence, amplifying his madness. His early cults splintered, many turning violently on one another as conflicting visions spread.",
		}),
		cyric_formation_history: await db.createDeityHistory({
			...
			deityId: deities.cyric.id,
			description:
				'Cyricite sects began infiltrating courts and guilds, engineering assassinations and civil unrest. Several short-lived theocracies collapsed due to internal betrayal.',
		}),
		cyric_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.cyric.id,
			description:
				"A period known as the Fractured Dogma saw Cyric's followers war against each other over contradictory revelations. Despite this, his influence grew through fear and chaos rather than devotion.",
		}),
		cyric_modern_history: await db.createDeityHistory({
			...
			deityId: deities.cyric.id,
			description:
				'In the current age, Cyric is worshiped primarily in secret. His cults are blamed for several major political collapses and the rise of the Veiled Knives, an infamous assassin network operating across continents.',
		}),
		tempus_bringing_history: await db.createDeityHistory({
			...
			description:
				"Initially confused by The Bringing, Tempus's followers struggled to maintain their faith in a new world. Many turned to him for guidance during the early conflicts and resource wars.",
		}),
		tempus_formation_history: await db.createDeityHistory({
			...
			deityId: deities.tempus.id,
			description:
				"Gained prominence during the First Continental War, with his temples becoming centers of military training and strategy. The Huntbound Order's founding in 755 cycles marked a major resurgence of his influence.",
		}),
		tempus_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.tempus.id,
			description:
				'Became the patron deity of the Huntbound Order, with Tharos Raggenthraw being a devoted follower. His influence spread across all continents as the guild expanded.',
		}),
		tempus_modern_history: await db.createDeityHistory({
			...
			deityId: deities.tempus.id,
			description:
				'Currently at the height of his power in Alabastria, with the Huntbound Order serving as his primary religious organization. His temples are found in every major city.',
		}),
		mystra_bringing_history: await db.createDeityHistory({
			...
			description:
				"Her followers were among the first to adapt to Alabastria's unique magical properties, establishing the first magical research centers.",
		}),
		mystra_formation_history: await db.createDeityHistory({
			...
			deityId: deities.mystra.id,
			description:
				"Gained significant influence during Kuriguer's Magic Surge, with her temples becoming centers of magical learning and research.",
		}),
		mystra_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.mystra.id,
			description:
				'Established the first magical academies in Kuriguer, becoming the primary patron of magical education and research across Alabastria.',
		}),
		mystra_modern_history: await db.createDeityHistory({
			...
			deityId: deities.mystra.id,
			description:
				"Currently maintains the most prestigious magical institutions in Alabastria, with her followers being the primary researchers of the continent's magical anomalies.",
		}),
		lathander_bringing_history: await db.createDeityHistory({
			...
			description:
				'Provided hope and healing during the chaotic early years of The Bringing, with his temples becoming sanctuaries for the displaced.',
		}),
		lathander_formation_history: await db.createDeityHistory({
			...
			deityId: deities.lathander.id,
			description:
				'Gained prominence as a patron of agriculture and renewal, with his followers helping establish the first successful farming communities in Skratonia.',
		}),
		lathander_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.lathander.id,
			description:
				'Became the primary patron of healing and renewal across all continents, with his temples serving as centers of medical knowledge and agricultural innovation.',
		}),
		lathander_modern_history: await db.createDeityHistory({
			...
			deityId: deities.lathander.id,
			description:
				'Currently maintains the most extensive healing network in Alabastria, with his followers being the primary healers and agricultural advisors across all continents.',
		}),
		selune_bringing_history: await db.createDeityHistory({
			...
			description:
				'Guided the first explorers and settlers as they navigated the new world, with her temples serving as navigation aids and safe havens.',
		}),
		selune_formation_history: await db.createDeityHistory({
			...
			deityId: deities.selune.id,
			description:
				'Gained prominence as a patron of exploration and trade, with her followers establishing the first trade routes and navigation systems.',
		}),
		selune_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.selune.id,
			description:
				'Became the primary patron of maritime trade and exploration, with her temples serving as lighthouses and navigation centers along all coastlines.',
		}),
		selune_modern_history: await db.createDeityHistory({
			...
			deityId: deities.selune.id,
			description:
				'Currently maintains the most extensive navigation network in Alabastria, with her followers being the primary guides for all maritime and overland travel.',
		}),
		shar_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among those who lost everything in The Bringing, with her temples serving as places of mourning and secret gathering.',
		}),
		shar_formation_history: await db.createDeityHistory({
			...
			deityId: deities.shar.id,
			description:
				'Established a network of hidden shrines and secret societies, with her followers becoming the primary information brokers and spies across all continents.',
		}),
		shar_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.shar.id,
			description:
				'Became the patron of the shadow economy and underground networks, with her followers controlling much of the information flow between continents.',
		}),
		shar_modern_history: await db.createDeityHistory({
			...
			deityId: deities.shar.id,
			description:
				'Currently maintains the most extensive information network in Alabastria, with her followers being the primary spies and information brokers across all continents.',
		}),
		oghma_bringing_history: await db.createDeityHistory({
			...
			description:
				"In the aftermath of The Bringing, Oghma's faithful focused on salvaging texts, oral histories, and lost languages. Many risked their lives to preserve fragments of the old world's knowledge.",
		}),
		oghma_formation_history: await db.createDeityHistory({
			...
			deityId: deities.oghma.id,
			description:
				'Oghman libraries became centers of learning and diplomacy. The first Great Concord of Scholars was signed under his auspices, standardizing languages and historical records.',
		}),
		oghma_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.oghma.id,
			description:
				"A golden age of invention and exploration emerged, driven by Oghma's clergy encouraging experimentation and free exchange of ideas across continents.",
		}),
		oghma_modern_history: await db.createDeityHistory({
			...
			deityId: deities.oghma.id,
			description:
				"In the present age, Oghma's temples stand as neutral sanctuaries. His followers are instrumental in educating the masses and safeguarding truth against manipulation and deliberate falsehoods.",
		}),
		deneir_bringing_history: await db.createDeityHistory({
			...
			description:
				"Following The Bringing, Deneir's clergy raced to document events as they unfolded, believing that accurate records would prevent future chaos born of forgotten truth.",
		}),
		deneir_formation_history: await db.createDeityHistory({
			...
			deityId: deities.deneir.id,
			description:
				'Deneirite monasteries became centers of law and record-keeping. Many early Alabastrian legal codes were penned under his guidance.',
		}),
		deneir_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.deneir.id,
			description:
				"A surge in rune magic and glyph-based spellcraft elevated Deneir's status among mages and artificers, solidifying his role as guardian of written magic.",
		}),
		deneir_modern_history: await db.createDeityHistory({
			...
			deityId: deities.deneir.id,
			description:
				"In the current age, Deneir's followers act as trusted neutral recorders of treaties, histories, and magical research, often serving as arbiters when truth is disputed.",
		}),
		mask_bringing_history: await db.createDeityHistory({
			...
			description:
				"In the uncertain days after The Bringing, Mask's faithful became essential scouts, smugglers, and information gatherers. Many cities quietly relied on them despite public condemnation.",
		}),
		mask_formation_history: await db.createDeityHistory({
			...
			deityId: deities.mask.id,
			description:
				"Thieves' guilds formally organized under Mask's loose patronage, creating networks that spanned continents and traded in secrets as readily as coin.",
		}),
		mask_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.mask.id,
			description:
				"A golden age of espionage elevated Mask's influence. Shadow wars between rival states were often decided by Maskan agents before armies ever marched.",
		}),
		mask_modern_history: await db.createDeityHistory({
			...
			deityId: deities.mask.id,
			description:
				'In the present era, Mask is regarded with wary tolerance. His worship persists wherever laws are rigid, borders are tight, and secrets are valuable.',
		}),
		helm_bringing_history: await db.createDeityHistory({
			...
			description:
				"After The Bringing, Helm's followers focused on restoring order amidst widespread chaos. His priests advised leaders on maintaining law and discipline in vulnerable cities.",
		}),
		helm_formation_history: await db.createDeityHistory({
			...
			deityId: deities.helm.id,
			description:
				"Helm's influence expanded with the rise of city-states and organized militias. Watchtowers and fortified temples were constructed to safeguard urban centers.",
		}),
		helm_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.helm.id,
			description:
				"Helm's clergy became a respected force in law enforcement, mediating disputes and training guards. Many paladins and knights pledged service to him during regional conflicts.",
		}),
		helm_modern_history: await db.createDeityHistory({
			...
			deityId: deities.helm.id,
			description:
				"In the present age, Helm's faithful continue to safeguard Alabastria. His temples act as centers of civic defense, and his doctrines of vigilance and duty guide soldiers, guards, and lawkeepers across the land.",
		}),
		tyr_bringing_history: await db.createDeityHistory({
			...
			description:
				"Following The Bringing, Tyr's faithful worked to stabilize cities and regions, establishing courts and promoting impartial justice in a chaotic world.",
		}),
		tyr_formation_history: await db.createDeityHistory({
			...
			deityId: deities.tyr.id,
			description:
				"Tyr's influence expanded as legal codes were formalized across Alabastria. Paladins of Tyr acted as judges, mediators, and protectors of law.",
		}),
		tyr_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.tyr.id,
			description:
				"Tyr's clergy gained recognition as moral arbiters, intervening in disputes between rulers and kingdoms. His doctrines of fairness became a cornerstone of governance.",
		}),
		tyr_modern_history: await db.createDeityHistory({
			...
			deityId: deities.tyr.id,
			description:
				"In the current era, Tyr's temples serve as centers of law and justice. His followers continue to uphold fairness, mediate conflicts, and punish wrongdoing, ensuring that Tyr's ideals remain a guiding light in Alabastria.",
		}),
		chauntea_bringing_history: await db.createDeityHistory({
			...
			description:
				"After The Bringing, Chauntea's clergy focused on restoring agricultural systems disrupted by chaos. Seeds were planted anew, and knowledge of irrigation and crop rotation was shared widely.",
		}),
		chauntea_formation_history: await db.createDeityHistory({
			...
			deityId: deities.chauntea.id,
			description:
				'Rural communities grew in size and stability under her guidance. Festivals celebrating planting and harvest became widespread, reinforcing social cohesion.',
		}),
		chauntea_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.chauntea.id,
			description:
				'Her influence extended into urban centers as granaries, gardens, and public farms were established to feed growing populations. Druidic orders allied with her for land stewardship.',
		}),
		chauntea_modern_history: await db.createDeityHistory({
			...
			deityId: deities.chauntea.id,
			description:
				"In the present era, Chauntea's followers continue to ensure food security, protect farmland, and celebrate the cycles of growth and harvest. Her teachings influence both peasants and rulers who value the prosperity of the land.",
		}),
		ilmater_bringing_history: await db.createDeityHistory({
			...
			description:
				"After The Bringing, Ilmater's followers focused on aiding those devastated by upheaval. Temples acted as emergency relief centers for the displaced and wounded.",
		}),
		ilmater_formation_history: await db.createDeityHistory({
			...
			deityId: deities.ilmater.id,
			description:
				'Ilmaterite charities and hospitals were formalized, and orders of compassionate monks and clerics spread throughout Alabastria.',
		}),
		ilmater_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.ilmater.id,
			description:
				'His clergy became mediators and healers in war-torn regions. Pilgrimages to sites of past tragedies grew as acts of penance and service.',
		}),
		ilmater_modern_history: await db.createDeityHistory({
			...
			deityId: deities.ilmater.id,
			description:
				"In the present era, Ilmater's temples are vital centers for social welfare. His followers continue to alleviate suffering, provide refuge, and advocate for endurance, patience, and hope in the face of adversity.",
		}),
		talona_bringing_history: await db.createDeityHistory({
			...
			description:
				"In the chaos following The Bringing, Talona's influence spread rapidly through uncontrolled disease and spoiled food supplies. Early cultists flourished among refugees and the dying.",
		}),
		talona_formation_history: await db.createDeityHistory({
			...
			deityId: deities.talona.id,
			description:
				"Several devastating plagues were attributed to Talona's favor or wrath. Her worship became deeply feared, and many cities outlawed even speaking her name.",
		}),
		talona_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.talona.id,
			description:
				"Talona's followers refined poisons and diseases into weapons, selling their services to criminals and rival states. Her cults became more organized and secretive.",
		}),
		talona_modern_history: await db.createDeityHistory({
			...
			deityId: deities.talona.id,
			description:
				'In the current era, Talona is placated through forbidden rites rather than openly praised. Her cults are blamed for recent outbreaks collectively known as the Ashen Cough and the Black Bloom.',
		}),
		tymora_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among those who took risks to survive in the new world, with her temples serving as centers of hope and luck.',
		}),
		tymora_formation_history: await db.createDeityHistory({
			...
			deityId: deities.tymora.id,
			description:
				'Became the patron of early adventurers and explorers, with her temples serving as gathering places for those seeking fortune and adventure.',
		}),
		tymora_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.tymora.id,
			description:
				'Gained significant influence among the Huntbound Order and other adventuring groups, with her temples becoming centers of luck and fortune.',
		}),
		tymora_modern_history: await db.createDeityHistory({
			...
			deityId: deities.tymora.id,
			description:
				'Currently maintains the most extensive network of luck and fortune in Alabastria, with her followers being the primary patrons of adventurers and risk takers.',
		}),
		beshaba_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among those who suffered the most from The Bringing, with her temples serving as places of mourning and curse work.',
		}),
		beshaba_formation_history: await db.createDeityHistory({
			...
			deityId: deities.beshaba.id,
			description:
				'Established a network of cursed shrines and accident sites, with her followers becoming the primary curse workers and hex specialists across all continents.',
		}),
		beshaba_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.beshaba.id,
			description:
				'Became the patron of the cursed and wronged, with her temples serving as centers of curse work and misfortune magic.',
		}),
		beshaba_modern_history: await db.createDeityHistory({
			...
			deityId: deities.beshaba.id,
			description:
				'Currently maintains the most extensive network of curse work and misfortune in Alabastria, with her followers being the primary curse workers and hex specialists.',
		}),
		kelemvor_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among those who dealt with the many deaths caused by The Bringing, with his temples serving as centers of death and judgment.',
		}),
		kelemvor_formation_history: await db.createDeityHistory({
			...
			deityId: deities.kelemvor.id,
			description:
				'Became the primary patron of death and judgment across all continents, with his temples serving as centers of justice and the dead.',
		}),
		kelemvor_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.kelemvor.id,
			description:
				'Established the most extensive network of death and judgment in Alabastria, with his followers being the primary judges and undertakers across all continents.',
		}),
		kelemvor_modern_history: await db.createDeityHistory({
			...
			deityId: deities.kelemvor.id,
			description:
				'Currently maintains the most extensive network of death and judgment in Alabastria, with his followers being the primary judges and undertakers across all continents.',
		}),
		bane_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among those who sought to control the chaos of The Bringing, with his temples serving as centers of tyranny and conquest.',
		}),
		bane_formation_history: await db.createDeityHistory({
			...
			deityId: deities.bane.id,
			description:
				'Became the patron of many ruling classes and military leaders, with his temples serving as centers of power and control across all continents.',
		}),
		bane_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.bane.id,
			description:
				'Established a network of tyrannical rule and military conquest, with his followers being the primary tyrants and conquerors across all continents.',
		}),
		bane_modern_history: await db.createDeityHistory({
			...
			deityId: deities.bane.id,
			description:
				'Currently maintains the most extensive network of tyranny and conquest in Alabastria, with his followers being the primary tyrants and conquerors across all continents.',
		}),
		myrkul_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among those who sought to cheat death in the new world, with his temples serving as centers of necromancy and undeath.',
		}),
		myrkul_formation_history: await db.createDeityHistory({
			...
			deityId: deities.myrkul.id,
			description:
				'Became the patron of necromancers and undead across all continents, with his temples serving as centers of death magic and undeath.',
		}),
		myrkul_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.myrkul.id,
			description:
				'Established a network of necromancy and undeath across all continents, with his followers being the primary necromancers and undead across all continents.',
		}),
		myrkul_modern_history: await db.createDeityHistory({
			...
			deityId: deities.myrkul.id,
			description:
				'Currently maintains the most extensive network of necromancy and undeath in Alabastria, with his followers being the primary necromancers and undead across all continents.',
		}),
		jergal_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among those who sought to record the history of The Bringing, with his temples serving as centers of record keeping and knowledge.',
		}),
		jergal_formation_history: await db.createDeityHistory({
			...
			deityId: deities.jergal.id,
			description:
				'Became the patron of scribes and historians across all continents, with his temples serving as centers of record keeping and knowledge.',
		}),
		jergal_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.jergal.id,
			description:
				'Established the most extensive network of record keeping and knowledge in Alabastria, with his followers being the primary scribes and historians across all continents.',
		}),
		jergal_modern_history: await db.createDeityHistory({
			...
			deityId: deities.jergal.id,
			description:
				'Currently maintains the most extensive network of record keeping and knowledge in Alabastria, with his followers being the primary scribes and historians across all continents.',
		}),
		moradin_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among dwarven settlers who sought to establish their craft in the new world, with his temples serving as centers of craftsmanship and creation.',
		}),
		moradin_formation_history: await db.createDeityHistory({
			...
			deityId: deities.moradin.id,
			description:
				'Became the patron of dwarven communities across all continents, with his temples serving as centers of craftsmanship and creation.',
		}),
		moradin_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.moradin.id,
			description:
				'Established the most extensive network of craftsmanship and creation in Alabastria, with his followers being the primary craftsmen and creators across all continents.',
		}),
		moradin_modern_history: await db.createDeityHistory({
			...
			deityId: deities.moradin.id,
			description:
				'Currently maintains the most extensive network of craftsmanship and creation in Alabastria, with his followers being the primary craftsmen and creators across all continents.',
		}),
		berronar_truesilver_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among dwarven families who sought to establish their homes in the new world, with her temples serving as centers of family and protection.',
		}),
		berronar_truesilver_formation_history: await db.createDeityHistory({
			...
			deityId: deities.berronar_truesilver.id,
			description:
				'Became the patron of dwarven families across all continents, with her temples serving as centers of family and protection.',
		}),
		berronar_truesilver_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.berronar_truesilver.id,
			description:
				'Established the most extensive network of family and protection in Alabastria, with her followers being the primary protectors and home keepers across all continents.',
		}),
		berronar_truesilver_modern_history: await db.createDeityHistory({
			...
			deityId: deities.berronar_truesilver.id,
			description:
				'Currently maintains the most extensive network of family and protection in Alabastria, with her followers being the primary protectors and home keepers across all continents.',
		}),
		clangeddin_silverbeard_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among dwarven warriors who sought to protect their people in the new world, with his temples serving as centers of battle and honor.',
		}),
		clangeddin_silverbeard_formation_history: await db.createDeityHistory({
			...
			deityId: deities.clangeddin_silverbeard.id,
			description:
				'Became the patron of dwarven warriors across all continents, with his temples serving as centers of battle and honor.',
		}),
		clangeddin_silverbeard_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.clangeddin_silverbeard.id,
			description:
				'Established the most extensive network of battle and honor in Alabastria, with his followers being the primary warriors and honor seekers across all continents.',
		}),
		clangeddin_silverbeard_modern_history: await db.createDeityHistory({
			...
			deityId: deities.clangeddin_silverbeard.id,
			description:
				'Currently maintains the most extensive network of battle and honor in Alabastria, with his followers being the primary warriors and honor seekers across all continents.',
		}),
		dugmaren_brightmantle_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among dwarven inventors who sought to adapt their technology to the new world, with his temples serving as centers of discovery and innovation.',
		}),
		dugmaren_brightmantle_formation_history: await db.createDeityHistory({
			...
			deityId: deities.dugmaren_brightmantle.id,
			description:
				'Became the patron of dwarven inventors across all continents, with his temples serving as centers of discovery and innovation.',
		}),
		dugmaren_brightmantle_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.dugmaren_brightmantle.id,
			description:
				'Established the most extensive network of discovery and innovation in Alabastria, with his followers being the primary inventors and researchers across all continents.',
		}),
		dugmaren_brightmantle_modern_history: await db.createDeityHistory({
			...
			deityId: deities.dugmaren_brightmantle.id,
			description:
				'Currently maintains the most extensive network of discovery and innovation in Alabastria, with his followers being the primary inventors and researchers across all continents.',
		}),
		vergadain_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among dwarven merchants who sought to establish trade in the new world, with his temples serving as centers of wealth and trade.',
		}),
		vergadain_formation_history: await db.createDeityHistory({
			...
			deityId: deities.vergadain.id,
			description:
				'Became the patron of dwarven merchants across all continents, with his temples serving as centers of wealth and trade.',
		}),
		vergadain_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.vergadain.id,
			description:
				'Established the most extensive network of wealth and trade in Alabastria, with his followers being the primary merchants and traders across all continents.',
		}),
		vergadain_modern_history: await db.createDeityHistory({
			...
			deityId: deities.vergadain.id,
			description:
				'Currently maintains the most extensive network of wealth and trade in Alabastria, with his followers being the primary merchants and traders across all continents.',
		}),
		corellon_larethian_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among elven settlers who sought to establish their art and magic in the new world, with his temples serving as centers of creativity and magic.',
		}),
		corellon_larethian_formation_history: await db.createDeityHistory({
			...
			deityId: deities.corellon_larethian.id,
			description:
				'Became the patron of elven communities across all continents, with his temples serving as centers of art and magic.',
		}),
		corellon_larethian_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.corellon_larethian.id,
			description:
				'Established the most prestigious magical and artistic institutions in Alabastria, with his followers being the primary creators and magical researchers across all continents.',
		}),
		corellon_larethian_modern_history: await db.createDeityHistory({
			...
			deityId: deities.corellon_larethian.id,
			description:
				'Currently maintains the most extensive network of art and magic in Alabastria, with his followers being the primary artists and magical researchers across all continents.',
		}),
		sehanine_moonbow_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among elven rangers who sought to explore the new world, with her temples serving as centers of dreams and journeys.',
		}),
		sehanine_moonbow_formation_history: await db.createDeityHistory({
			...
			deityId: deities.sehanine_moonbow.id,
			description:
				'Became the patron of elven rangers across all continents, with her temples serving as centers of exploration and dreams.',
		}),
		sehanine_moonbow_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.sehanine_moonbow.id,
			description:
				'Established the most extensive network of exploration and dreams in Alabastria, with her followers being the primary rangers and explorers across all continents.',
		}),
		sehanine_moonbow_modern_history: await db.createDeityHistory({
			...
			deityId: deities.sehanine_moonbow.id,
			description:
				'Currently maintains the most extensive network of exploration and dreams in Alabastria, with her followers being the primary rangers and explorers across all continents.',
		}),
		hanali_celanil_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among elven communities who sought to maintain their culture of beauty and love in the new world, with her temples serving as centers of love and beauty.',
		}),
		hanali_celanil_formation_history: await db.createDeityHistory({
			...
			deityId: deities.hanali_celanil.id,
			description:
				'Became the patron of elven communities across all continents, with her temples serving as centers of love and beauty.',
		}),
		hanali_celanil_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.hanali_celanil.id,
			description:
				'Established the most extensive network of love and beauty in Alabastria, with her followers being the primary artists and lovers across all continents.',
		}),
		hanali_celanil_modern_history: await db.createDeityHistory({
			...
			deityId: deities.hanali_celanil.id,
			description:
				'Currently maintains the most extensive network of love and beauty in Alabastria, with her followers being the primary artists and lovers across all continents.',
		}),
		labelas_enoreth_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among elven scholars who sought to record the history of The Bringing, with his temples serving as centers of time and wisdom.',
		}),
		labelas_enoreth_formation_history: await db.createDeityHistory({
			...
			deityId: deities.labelas_enoreth.id,
			description:
				'Became the patron of elven scholars across all continents, with his temples serving as centers of time and wisdom.',
		}),
		labelas_enoreth_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.labelas_enoreth.id,
			description:
				'Established the most extensive network of time and wisdom in Alabastria, with his followers being the primary historians and scholars across all continents.',
		}),
		labelas_enoreth_modern_history: await db.createDeityHistory({
			...
			deityId: deities.labelas_enoreth.id,
			description:
				'Currently maintains the most extensive network of time and wisdom in Alabastria, with his followers being the primary historians and scholars across all continents.',
		}),
		solonor_thelandira_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among elven rangers who sought to hunt and explore the new world, with his temples serving as centers of archery and hunting.',
		}),
		solonor_thelandira_formation_history: await db.createDeityHistory({
			...
			deityId: deities.solonor_thelandira.id,
			description:
				'Became the patron of elven rangers across all continents, with his temples serving as centers of archery and hunting.',
		}),
		solonor_thelandira_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.solonor_thelandira.id,
			description:
				'Established the most extensive network of archery and hunting in Alabastria, with his followers being the primary rangers and hunters across all continents.',
		}),
		solonor_thelandira_modern_history: await db.createDeityHistory({
			...
			deityId: deities.solonor_thelandira.id,
			description:
				'Currently maintains the most extensive network of archery and hunting in Alabastria, with his followers being the primary rangers and hunters across all continents.',
		}),
		lolth_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among dark elves who sought to establish their power in the new world, with her temples serving as centers of deception and domination.',
		}),
		lolth_formation_history: await db.createDeityHistory({
			...
			deityId: deities.lolth.id,
			description:
				'Became the patron of dark elves across all continents, with her temples serving as centers of deception and domination.',
		}),
		lolth_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.lolth.id,
			description:
				'Established a network of deception and domination across all continents, with her followers being the primary deceivers and power seekers across all continents.',
		}),
		lolth_modern_history: await db.createDeityHistory({
			...
			deityId: deities.lolth.id,
			description:
				'Currently maintains a network of deception and domination in Alabastria, with her followers being the primary deceivers and power seekers across all continents.',
		}),
		vhaeraun_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among dark elves who sought to rebel against the new world order, with his temples serving as centers of shadow and rebellion.',
		}),
		vhaeraun_formation_history: await db.createDeityHistory({
			...
			deityId: deities.vhaeraun.id,
			description:
				'Became the patron of dark elves across all continents, with his temples serving as centers of shadow and rebellion.',
		}),
		vhaeraun_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.vhaeraun.id,
			description:
				'Established a network of shadow and rebellion across all continents, with his followers being the primary rebels and thieves across all continents.',
		}),
		vhaeraun_modern_history: await db.createDeityHistory({
			...
			deityId: deities.vhaeraun.id,
			description:
				'Currently maintains a network of shadow and rebellion in Alabastria, with his followers being the primary rebels and thieves across all continents.',
		}),
		eilistraee_bringing_history: await db.createDeityHistory({
			...
			description:
				'Gained followers among dark elves who sought redemption in the new world, with her temples serving as centers of song and redemption.',
		}),
		eilistraee_formation_history: await db.createDeityHistory({
			...
			deityId: deities.eilistraee.id,
			description:
				'Became the patron of redeemed dark elves across all continents, with her temples serving as centers of song and redemption.',
		}),
		eilistraee_expansion_history: await db.createDeityHistory({
			...
			deityId: deities.eilistraee.id,
			description:
				'Established a network of song and redemption across all continents, with her followers being the primary bards and redemption seekers across all continents.',
		}),
		eilistraee_modern_history: await db.createDeityHistory({
			...
			deityId: deities.eilistraee.id,
			description:
				'Currently maintains a network of song and redemption in Alabastria, with her followers being the primary bards and redemption seekers across all continents.',
		}),
